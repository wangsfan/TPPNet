...
class CUB200(iData):
    ...
    def download_data(self):
        #rootdir = "[DATA-PATH]"
        rootdir = "./data/CUB_200_2011/images"
        train_txt = './data/datautils/cub_200/train.txt'
        test_txt = './data/datautils/cub_200/test.txt'
...
class eurosat(iData):
    ...
    def download_data(self):
        #rootdir = "[DATA-PATH]"
        rootdir = "./data/eurosat"
        train_txt = './data/datautils/eurosat/train.txt'
        test_txt = './data/datautils/eurosat/test.txt'
