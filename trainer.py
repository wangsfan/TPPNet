...
def _train(args):
    ...
    model = factory.get_model(args['model_name'], data_manager.class_name_list, args)
    ...
    for task in range(data_manager.nb_tasks):
        ...
        if task > 0:
            for name, param in model._network.image_encoder.named_parameters():
                if name.startswith('knowladge'):
