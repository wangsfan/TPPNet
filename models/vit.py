...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.APG = nn.ModuleList([APG(embedding_dim=embed_dim,
                        MLP_num=MLP_num,
                        num_heads=num_heads_APG,
                        proj_drop=proj_drop,
                        attn_drop=attn_drop,
                        more_prompts=more_prompts,
                        attn_depth=attn_depth,
                        use_update_tokens=use_update_tokens,
                        cross_attn_wo_x=cross_attn_wo_x,
                        residual=residual, 
                        bayes=bayes) for _ in range(12)])
